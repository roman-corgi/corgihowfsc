...
| `sequences.yaml`                                    | [corgi_ObsPlanning](https://github.com/roman-corgi/corgi_ObsPlanning/blob/main/eetc_sequences/sequences.yaml)                                               |
...
Move `sequences.yaml` file from downloads to `cgi-eetc\eetc\config`. If you are uncertain where your cgi-eetc installation lives, 
```python
