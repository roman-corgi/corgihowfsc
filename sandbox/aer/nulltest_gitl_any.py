...
"""
Use howfsc_computation with corgisim for any Roman CGI modes.
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument('--mode', default='nfov_band1', help="coronagraph mode from test data; must be one of 'widefov', 'narrowfov', 'nfov_dm', 'nfov_flat', or 'spectroscopy'.  Defaults to 'widefov'.")
    ...
    if mode == 'nfov_band1':
        modelpath = os.path.join(howfscpath, 'model', 'testdata', 'nfov_band1')
        ...
        hconffile = os.path.join(modelpath, 'hconf_nfov_band1.yaml')
        n2clistfiles = [
        ...
        modelpath = os.path.join(howfscpath, 'model', 'testdata', 'nfov_band1_half')
        cfgfile = os.path.join(modelpath, 'howfsc_optical_model_seeded.yaml')
        ...
        modelpath = os.path.join(howfscpath, 'model', 'testdata', 'spec_band2')
        cfgfile = os.path.join(modelpath, 'howfsc_optical_model_seeded.yaml')
        ...
        modelpath = os.path.join(howfscpath, 'model', 'testdata', 'spec_band3')
        cfgfile = os.path.join(modelpath, 'howfsc_optical_model_seeded.yaml')
        ...
        modelpath = os.path.join(howfscpath, 'model', 'testdata', 'wfov_band4')
        cfgfile = os.path.join(modelpath, 'howfsc_optical_model_seeded.yaml')
