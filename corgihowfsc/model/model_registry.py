...
PROBE_FILES = {
    ...
    'specrot_band2': ProbeFiles(
        default=['specrot_band2_dmrel_1.0e-05_cos120_p0.fits', 'specrot_band2_dmrel_1.0e-05_cos120_p1.fits', 'specrot_band2_dmrel_1.0e-05_cos120_p2.fits'],
    ),
    'specrot_band3': ProbeFiles(
        default=['specrot_band3_dmrel_1.0e-05_cos120_p0.fits', 'specrot_band3_dmrel_1.0e-05_cos120_p1.fits', 'specrot_band3_dmrel_1.0e-05_cos120_p2.fits'],
    ),
}
...
DM_STARTMAP_FILES = {
    'nfov_band1':    ('band1_flat_wfe_dm1_v.fits', 'band1_flat_wfe_dm2_v.fits'),
    'wfov_band1':    ('band1_flat_wfe_dm1_v.fits', 'band1_flat_wfe_dm2_v.fits'),
    'wfov_band4':    ('band4_flat_wfe_dm1_v.fits', 'band4_flat_wfe_dm2_v.fits'),
    'spec_band2':    ('band2_flat_wfe_dm1_v.fits', 'band2_flat_wfe_dm2_v.fits'),
    'spec_band3':    ('band3_flat_wfe_dm1_v.fits', 'band3_flat_wfe_dm2_v.fits'),
    'specrot_band2': ('band2_flat_wfe_dm1_v.fits', 'band2_flat_wfe_dm2_v.fits'),
    'specrot_band3': ('band3_flat_wfe_dm1_v.fits', 'band3_flat_wfe_dm2_v.fits'),
}
