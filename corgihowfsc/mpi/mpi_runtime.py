...
def build_worker_init_config(args, cfgfile, cstratfile, hconffile, backend_type, mode, corgi_overrides, emccd_overrides, cosmic_ray_filtering):
    """
    ...
    return {
        ...
        'cosmic_ray_filtering': cosmic_ray_filtering,
